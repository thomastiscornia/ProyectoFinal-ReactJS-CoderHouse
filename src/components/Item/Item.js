    ...
    <>
      <Col data-aos="fade-up" className='containerProduct d-flex row col-xl-3  text-light'>
        <div className='productItem m-3'>
          <Card.Img variant='top' className='productImg img-fluid' src={props.imagen} alt={props.bebida} />
          <Card.Body className='productItemBody'>
            <Card.Header className='productHeader '>{props.marca}</Card.Header>
            <Card.Title className='productTittle '>{props.bebida}</Card.Title>
